...
class Penanamanbjm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Center(child: Text('PENANAMAN BANJARMASIN',style: GoogleFonts.acme(color: Colors.white,  ),)),
          bottom: TabBar(
            tabs: [
              Tab(icon: Icon(Icons.forest_outlined), text: 'Barat'),
              Tab(icon: Icon(Icons.forest_sharp), text: 'Selatan'),
              Tab(icon: Icon(Icons.forest_rounded), text: 'Tengah'),
              Tab(icon: Icon(Icons.forest), text: 'Timur'),
              Tab(icon: Icon(Icons.forest_outlined), text: 'Utara'),
